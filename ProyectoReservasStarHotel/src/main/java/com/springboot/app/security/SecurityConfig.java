...
public class SecurityConfig {
	...
	SecurityFilterChain securityFilterChain(HttpSecurity http, AuthenticationManager authManager) throws Exception {
		...
		return http
				...
				.antMatchers("/api/habitaciones/**").permitAll()
				.antMatchers("/api/servicios/**").permitAll()
				.antMatchers("/api/reservaciones/**").permitAll()
				.antMatchers("/api/pagos/**").permitAll()
				.antMatchers("/api/huespedes/**").permitAll()
	...
	/*public static void main(String[] args) {
		...
		System.out.println(encoder.encode("mateo"));
	}*/
