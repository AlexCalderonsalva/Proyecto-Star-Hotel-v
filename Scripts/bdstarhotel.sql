...
insert into tb_rol (descripcion_rol, nombre_rol) values ("Rol de Cliente", "Cliente");
...
insert into tb_usuario (nombre, apellido, email, contrasena, telefono, direccion, estado, id_rol) VALUES
('Mateo', 'Gomez', 'mateo@gmail.com', '$2a$10$FLzaVwAG.5sC.uEL.f5cDu74xXrTZ6Lvwfujz2PmOkiNHyKHjk.Xa', '933829302', 'Jesus Maria', 'ACTIVO', 2);
